        ...
        {promoResult?.valid ? (
          <div className="space-y-1">
            ...
            <p className="text-sm text-green-600">
              Promo code &quot;{promoResult.promoCode?.name}&quot; applied! 
              {promoResult.discountAmount && ` You save ${promoResult.discountAmount.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}`}
            </p>
          </div>
        ) : (
          <div>
        ...
        {promoResult?.valid ? (
          <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-green-700">{promoResult.promoCode?.name}</span>
            </div>
            <button
              type="button"
